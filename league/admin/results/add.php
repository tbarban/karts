...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" style="padding-top: 40px;">
      <div class="container">
        <form action="./view.php?id=<?php echo $raceID;?>&action=add" method="post">
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input name="lapsRun" type="text" class="form-control" id="lapsRun" placeholder="Laps Run">
            </div>
            <div class="form-group">
              <label for="heatID">Feature Heat ID</label>
              <input name="heatID" type="text" class="form-control" id="heatID" placeholder="Heat ID">
            </div>
            <div class="form-group">
              <label for="qualID">Qualification Heat ID</label>
              <input name="qualID" type="text" class="form-control" id="qualID" placeholder="Qualification ID">
            </div>
