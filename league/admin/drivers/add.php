          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <input name="racerName" type="text" class="form-control" id="racerName" placeholder="Driver Name">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input name="customerID" type="text" class="form-control" id="customerID" placeholder="Customer ID (100xxxx)">
              </div>
