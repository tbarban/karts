...
<html lang="en">
  <head>
    ...
    <title>About \ Top Karting Racing League</title>
  </head>
  ...
  <body>
    ...
    <main role="main">
      <div class="jumbotron">
        <div class="container">
          <h1 class="display-4">About the League</h1>
        </div>
      </div>

      <div class="container">
        <a href="http://motherfuckingwebsite.com" target="_blank">Filler text from motherfuckingwebsite.com</a>
